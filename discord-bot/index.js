        ...
        try {
            ...
            if (staffChannel) {
                const staffUpdateMessage = `**Staff Command & System Update**\n> *New administrative commands and system limits have been implemented for moderation.*\n\n` +
                                           ...
                                           `+ /givefish [player] [fishName] [weight] - (NEW) Rahasia memberikan ikan custom spesifik beserta angkanya kepada pemain.\n` +
                                           ...
                                           `⇄ **Changes & Limits**\n\`\`\`md\n` +
                                           `# Pet System API: Backend sistem Database telah di-update untuk meng-handle penyimpanan OwnedPets dan EquippedPet secara aman.\n` +
